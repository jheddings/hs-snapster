-- Unit tests for the FrameLayout module

local lu = require("luaunit")
local FrameLayout = require("src.layout")
...
function TestFrameLayout:testLeftAnchor()
    local layout = FrameLayout:new("left")
...
function TestFrameLayout:testRightAnchor()
    local layout = FrameLayout:new("right")
    local frame = layout:apply(self.mockWindow)
...
function TestFrameLayout:testTopAnchor()
    local layout = FrameLayout:new("top")
    local frame = layout:apply(self.mockWindow)
...
function TestFrameLayout:testBottomAnchor()
    local layout = FrameLayout:new("bottom")
    local frame = layout:apply(self.mockWindow)
...
function TestFrameLayout:testBottomRightCorner()
    local layout = FrameLayout:new("right", "bottom")
    local frame = layout:apply(self.mockWindow)
